  ...
  return (
    <section className="max-w-200 mx-auto p-4 text-left">
      ...
      <p className="my-4">
        ...
        by FFD700 AS (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). It
        describes how we collect, use, and share information in connection with
        your use of the dgputt app (the &quot;Service&quot;). By using the
      ...
      <p className="my-4">
        ...
        You have the option to accept or refuse these cookies. If you choose to
        refuse cookies, some portions of this Service may not function as
        intended.
      </p>
      ...
      <p className="my-4">
        ...
        behalf and are obligated not to disclose or use the information for any
        other purpose.
      </p>
      ...
      <p className="my-4">
        ...
        <a href="mailto:contact@dgputt.app" className="underline text-blue-700">
          contact@dgputt.app
        </a>
        .
      </p>
